...
def create_client(ctx, path: str, protocol: str, host: str, token: str = None, name: str = None, group: int = None):
    ...
    - name: client name (set with argument, query, or autogenerated)
    - refresh_token: from context file
    - token: get tokens from context file
    - path: user to decide where client file is located?
    """
