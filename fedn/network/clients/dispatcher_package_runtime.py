...
class DispatcherPackageRuntime:
    ...
    def __init__(self, package_path: str) -> None:
        ...
        self.dispatch_config: Optional[dict] = None
    ...
    def set_dispatcher(self, run_path: str) -> bool:
        ...
        try:
            ...
            self.dispatcher = Dispatcher(self.dispatch_config, run_path)
        except Exception as e:
