...
def load_parameters(model, model_file: ScaleoutModel):
    weights = model_file.get_model_params(helper=helper)
...
def save_parameters(model):
    ...
    return ScaleoutModel.from_model_params(parameters_np, helper=helper)
