...
from scaleout.client.edge_client import ConnectToApiResult
...
def on_train(in_model: ScaleoutModel, client_settings):
    model_params = in_model.get_model_params(helper=helper)
    # Load model from temp file
    resnet18 = load_parameters(model_params)
...
if __name__ == "__main__":
    ...
    client = EdgeClient(train_callback=on_train, validate_callback=on_validate)
